...
<body>
<h1 style="text-align:center; font-size: 4rem; color: #2F323A">ConnectU</h1>
	<div class="main">
		<!-- Sign up form -->
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 size class="form-title">Registro</h2>
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="user" id="user" placeholder="Nombre de Usuario" />
							</div>
							<div class="form-group">
